...
import { Search, Filter, Plus, ArrowLeft, Mail, Phone, MapPin, GraduationCap, BookOpen, Users, Edit, Trash2 } from "lucide-react";
...
const ProfessorManagement = () => {
  ...
  const filteredProfessors = professors.filter(professor => {
    ...
    const matchesSchool = schoolFilter === "all" || 
                         professor.schools.some(school => 
                           schools.find(s => s.id === schoolFilter)?.name === school
                         );
