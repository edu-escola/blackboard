...
const AdminDashboard = () => {
  ...
  const recentActivity = [
    { id: 1, type: "Student Added", name: "Alice Johnson", school: "Lincoln Elementary", time: "2 hours ago" },
    { id: 2, type: "Professor Added", name: "Dr. Smith", school: "Washington High", time: "4 hours ago" },
    { id: 3, type: "Student Added", name: "Bob Wilson", school: "Roosevelt Middle", time: "6 hours ago" },
    { id: 4, type: "Professor Added", name: "Ms. Davis", school: "Lincoln Elementary", time: "1 day ago" },
    { id: 5, type: "Student Added", name: "Carol Brown", school: "Washington High", time: "1 day ago" }
  ];

  const quickActions = [
    { title: "Add Student", icon: UserPlus, color: "bg-blue-600 hover:bg-blue-700" },
    { title: "Add Professor", icon: GraduationCap, color: "bg-green-600 hover:bg-green-700" },
    { title: "Create Class", icon: BookOpen, color: "bg-purple-600 hover:bg-purple-700" },
    { title: "Invite Admin", icon: Plus, color: "bg-orange-600 hover:bg-orange-700" }
  ];
